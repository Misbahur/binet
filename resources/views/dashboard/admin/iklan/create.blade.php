        ...
        <form action="{{ route('iklan.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-12 col-lg-4">
              ...
              <input type="text" name="awalTampil" class="form-control @error('awalTampil') is-invalid @enderror datepicker" id="awalTampil" value="{{ old('awalTampil') }}" autocomplete="off">
              @error('awalTampil')
                <p class="text-danger">{{ $message }}</p>
              @enderror
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-12 col-lg-4">
              ...
              <input type="text" name="akhirTampil" class="form-control @error('akhirTampil') is-invalid @enderror dateicker" id="akhirTampil" value="{{ old('akhirTampil') }}" autocomplete="off">
              @error('akhirTampil')
                <p class="text-danger">{{ $message }}</p>
              @enderror
            </div>
