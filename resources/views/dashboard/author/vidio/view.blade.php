    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item pr-4">
          <a class="nav-link" href="{{ route('authorvidio.index') }}">Home</a>
        </li>
        <li class="nav-item pr-4">
  ...
  <main class="mb-5">
    ...
    <div class="main-content">
      <nav aria-label="breadcrumb">
        <div class="container">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('authorvidio.index') }}">News</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ $video->slug }}</li>
          </ol>
        </div>
      </nav>
