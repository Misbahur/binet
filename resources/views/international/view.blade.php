    ...
    <div class="container">
      <div class="row mr-lg-3 ml-lg-4">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="{{ route('international') }}">International</a></li>
              ...
              @foreach ($newsLimit as $newsL)
                <div class="media mt-3">
                  <div class="zoom-effect">
                    <div class="kotak">
                      <img src="{{ url('/storage/thumbnails', $news->thumbnail) }}" class="mr-3 rounded" alt="..." height="75px" width="100px">
                    </div>  
                  </div>
